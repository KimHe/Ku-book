...
The result is that John Smith gets on very badly with John Chinaman, and, what is still worse, under the civilising influence of John Smith's $a$ plus $b$ equal $c$ Anglo-Saxon ideals, John Chinaman, instead of being a good, honest, steady customer for Manchester goods neglects his business, goes to Chang Su-ho's Gardens \marinpar{\scriptsize Chang Su-ho's Gardens: 张叔和园，又称上海张园， 是清朝末年上海最大市民活动中心} to celebrate the Constitution, in fact becomes a mad, raving reformer.
...
\begin{enumerate}
    ...
    \item --- What is a state of human perfectibility? \\ Sir Robert Hart's \marginpar{\scriptsize Sir Robert Hart: (1835-1911) a British diplomat and official in Qing Chinese government.} Custom \marginpar{\scriptsize Custom [sic: Customs]} Service in China.
    ...
    \item --- Who is the great Apostle \marginpar{\scriptsize Apostle: 【基督教】传道者} of the Anglo-Saxon Ideals in China. \\ Dr.~Morrison, \marginpar{\scriptsize George Ernest Morrison: (1862-1920) an American adventurer and {\em The Times} correspondent.} the \emph{Times} Correspondent in Peking.
\end{enumerate}
...
In the end I fear John Bull Senior will not only find his Manchester goods trade ruined, but he will even be put to the expense of sending out a General Gordon \marginpar{\scriptsize Charles George Gorden: (1833-1885) a British Army officer. 他的军队在中国称为“洋枪队”或者“常胜军”} or Lord Kitchener \marginpar{\scriptsize Horatio Herbert Kichener: (1850-1916) a senior British Army officer and colonial administrator.} to shoot his poor old friend John Chinaman who has become \emph{non compes mentis} \marginpar{\scriptsize compes [sic: compos]} \marginpar{\scriptsize non compos mentis: of unsound mind, insane.} under the civilising influence of John Smith's Anglo-Saxon ideals.
...
Indeed when one remembers that in those old days, before the Rev. Arthur Smith wrote his ``Chinese Characteristics,'' the relations between the heads or taipans \marginpar{\scriptsize taipans: 旧中国洋行老板} of great British firms such as Jardine, Matheson and their Chinese compradores \marginpar{\scriptsize compradores: Chinese employed by foreign firms to agents between them and Chinese merchants.} were always those of mutual affection, passing on to one or more generations;
...
For in it there are many unknown quantities, not only such as the East of Confucius and the East of Mr.~Kang Yu-wei \marginpar{\scriptsize Kang Yu-wei: 康有为} and the Viceroy Tuan Fang \marginpar{\scriptsize Viceroy Tuan Fang: 总督 端方}, but also the West of Shakespeare and Goethe and the West of John Smith.
