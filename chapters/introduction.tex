...
\begin{center}
   \scriptsize
   Sage, thun\marginpar{\scriptsize Goethe predates unified German spelling, I have no idea what he actually wrote. In 1901 mandatory rules where released. They state that \emph{thun} should be replaced by \emph{tun}. However, I would guess that in 1910 the old th-spelling was still very popular especially with highly educated people. Therefore I would recomend to leave it like this.} wir nicht recht? Wir m\"ussen den P\"obel betr\"ugen,\\
...
But Englishmen say that they are determined to put down Prussian militarism and Lord Kitchner believes that he will be able to stamp out Prussian militarism with three million drilled and armed Englishmen.
