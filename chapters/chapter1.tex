...
Goethe says: ``Piety, (Fr\"ommigkeit\footnote{Fommigkeit in the original book}) \ie, the belief in God, taught by religion, is not an end in itself but only a means by which, through the complete and perfect calmness of mind and temper (Gem\"uthsruhe\marginpar{\scriptsize again the th is strictly speaking wrong here, but I would still leave it}\footnote{Gem\"uthsr\"uhe in the original book}) which it gives, to attain the highest state of culture or human perfection.''
