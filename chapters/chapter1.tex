...
``The docility of the Chinese,'' says the late Dr.~D.~J.~Macgowan, \marginpar{\scriptsize D.~J.~Macgowan: (?-?) He went to Ningbo in 1843 and established a Bapist missionary hospital (现宁波第二医院) after the First Optium War. 马高温} ``is not the docility of a broken-hearted, emasculated people.''
...
Some of you may have personally known an old friend and colleague of mine in Wuchang --- known him when he was Minister of the Foreign Office here in Peking --- Mr.~Liang Tun-yen, \marginpar{\scriptsize Liang Tun-yen: (1857-1924) was a diplomat and politian of Qing dynasty. 梁敦彦} Mr.~Liang told me, when he first received the appointment of the Customs Taotai of Hankow, \marginpar{\scriptsize Taotai of Hankow: 汉口道台} that what made him wish and strive to become a great mandarin, to wear the red button, and what gave him pleasure then in receiving this appointment, was not because he cared for the red button, not because he would henceforth be rich and independent, --- and we were all of us very poor then in Wuchang, --- but because he wanted to rejoice, because this promotion and advancement of his would gladden the heart of his old mother in Canton. \marginpar{\scriptsize Canton: 广东}
...
As it is said of the Kingdom of Heaven, \marginpar{\scriptsize Kingdom of Heaven: ?} so it may also be said of the Chinese language: --- ``Unless you become as little children, you cannot learn it.''
...
In fact the politeness of the Japanese is like a flower without fragrance, whereas the politeness of a really polite Chinese has a perfume like the aroma of a precious ointment --- \emph{instar unguenti fragrumis} \marginpar{\scriptsize instar unguenti fragrumis: Latin. ?} --- which comes from the heart.

Last of all, let us take another characteristic of the Chinese people, by calling attention to which the Rev.~Arthur Smith \marginpar{\scriptsize Rev.~Arthur Henderson Smith: (1845-1932) the author of Chinese Characteristics.} has made his reputation, viz: --- want of exactness.
...
Matthew Arnold \marginpar{\scriptsize Matthew Arnold: (1822-1888) an English poet and culture critic.} says: --- ``The poetry of medieval Christianity\footnote{Christainity in the original book} lived by the heart and imagination.''
...
Here let me quote an admirable saying of a famous living art critic, Mr.~Bernard Berenson. \marginpar{\scriptsize Bernard Berenson: (1865-1959) an American art critic, especially of Italian Renaissance art.}
...
It is thus given by an Englishman. \marginpar{\scriptsize Robert Kennaway Douglas: (1838-1913) a British oriental scholar.} 
Sir~Robert K.~Douglas, Professor of Chinese in the London University, in his study of Confucianism, say: \marginpar{\scriptsize say [sic: says]} --- ``Upwards of forty generations of Chinaman have been absolutely subjected to the dicta of one man. 
Being a Chinaman of Chinamen the teachings of Confucius were specially suited to the nature of those he taught. 
\emph{The Mongolian \marginpar{\scriptsize Mongolian: 现在科学已证实我们不是蒙古人种} mind being eminently phlegmatic and unspeculative}, naturally rebels against the idea of investigating matters beyond its experiences. 
...
Therefore philosophers, like Spinoza, \marginpar{\scriptsize Barach Spinoza: (1632-1677) a Jewish-Dutch philosopher.} ``for whom,'' it has been said, ``the crown of the intellectual life is a transport, as for\footnote{Lor in the original book} the saint the crown of the religious life is a transport,'' do not feel the need of religion.
...
Therefore scientific men like Darwin \marginpar{\scriptsize Charles Robert Darwin: (1809-1882) an English naturalist, geologist and biologist.} and Professor~Haeckel \marginpar{\scriptsize Ernst Heinrich Philipp August Haeckel  (1834-1919) a German biologist, naturalist, philosopher, physician and artist.} do not feel the need of religion.
...
Men, like Laotzu, \marginpar{\scriptsize Laotzu: 老子} then in China as men like Tolstoi\footnote{Tolstoy in the original book} \marginpar{\scriptsize Count Lyov Nikolayevich Tolstoy: (1828-1910) referred to in English as Leo Tolstoy, in Chinese 托尔斯泰, a Russian writer who is regarded as one of the greatest authors of all time.} in Europe today\footnote{to-day in the original book}, seeing the misery and suffering resulting from the conflict between the heart and the head, thought they saw something radically wrong in the very nature and constitution of society and civilisation.
Laotzu and Chuang-tzu, \marginpar{\scriptsize Chuang-tzu: 庄子} the most brilliant of Laotzu's disciples, told the Chinese people to throw away all civilisation.
...
But then Plato \marginpar{\scriptsize Plato: (428/427 or 424/423-348/347 BC) was a philosopher in Classical Greece and the founder of the Academy in Athens, the first institution of higher learning in the Western word. 柏拉图} and Aristotle \marginpar{\scriptsize Aristotle (384-322 BC): was an ancient Greek philosopher. 亚里士多德} in ancient times, and Rousseau \marginpar{\scriptsize Jean-Jacques Rousseau: (1712-1728) was a Genevan philosopher, writer and composer. 卢梭} and Herbert Spencer \marginpar{\scriptsize Herbert Spencer: (1820-1903) was an English philosopher, biologist, sociologist and classical liberal political theorist of the Victoria ear.}  in modern\footnote{modem in the original book} times also made a synthesis of civilisation, and tried to give a true idea of a State.
...
This book might also be called the Latter Day Annals, like the Latter Day Pamphlets of Carlyle. \marginpar{\scriptsize Latter-Day Pamphlets by Thomas Carlyle in 1850. Thomas Carlyle: (1795-1881) was a Scottish philosopher, satirical writer, essayist, translator, historian and teacher.}
...
I will only ask you to suspend your judgment \marginpar{\scriptsize judgment [sic: judgement]} until you have heard what I have further to say.
...
When I was in Japan last year the ex-Minister of Education, Baron Kikuchi, \marginpar{\scriptsize \emph{Baron} Kikuchi Dairoku: (1855-1917) was a mathematician, educator and education administrator in Meiji period Empire of Japan.} asked me to translate four Chinese characters taken from the book in which, as I said, Confucius taught this State religion of his.
The four characters were \emph{Ming fen ta yi} (名分大義).
I translated them as the Great Principle of Honour and Duty.
It is for this reason that the Chinese make a special distinction between Confucianism and all other religions by calling the system of teaching taught by Confucius not a \emph{chiao} (教) --- the general term in Chinese for religion with which they designate other religions, such as Buddhism, Mohammedanism and Christianity --- but the \emph{ming chiao} (名教) \marginpar{\scriptsize 名教：即礼教，孔子之礼教} --- the religion of Honour.
...
Later on in history before Confucius' time a great statesman arose in China --- the man known as the great Law-giver of China, generally spoken of as the Duke of Chou (周公) (B.C. 1135) \marginpar{\scriptsize 周公：姬姓，周氏，名旦。周文王第四子。} --- who first defined, fixed, and made a written code of the law of the gentleman, known then in China as \emph{li}, the law of propriety, good taste or good manners.
...
This Code of the laws of good manners of the Duke of Chou may be consideral \marginpar{\scriptsize consideral [sic: considered]} as the pre-Confucian religion in China, or, as the Mosaic law of the Jewish \marginpar{\scriptsize Mosaic law of the Jewish: 摩西法典} nation before Christianity is called, the Religion of the Old Dispensation of the Chinese people. \marginpar{\scriptsize Old dispensation: 旧约}
...
It is this fact which has made sceptics like Voltaire \marginpar{\scriptsize Frans\c{c}ois-Marie Arounet (Voltaire): (1694-1778) was a French Enlightment writer, historian and philosopher.} and Tom Paine \marginpar{\scriptsize Thomas Paine: (1737-1809) was an English born American political activist, philosopher, political theorist and revolutionary.} in the last century, and rationalists like Sir Hiram Maxim \marginpar{\scriptsize Hiram Stevens Maxim: (1840-1910) was an American born British inventor. He also compiled a book he called ``Li Hung Chang's scrapbook''.} today, say, that the belief in God is a fraud or imposture invented by the founders of religion and kept up by priests.
...
As the Psalmist \marginpar{\scriptsize Psalms is book of the Hebrew Bible} says: ``Only the fool --- the man with a vulgar and shallow intellect --- has said in his heart, `There is no God.'\thinspace''
...
The German Fichte \marginpar{\scriptsize Johann Gottlieb Fichte: (1762-1814) a German philosopher.} calls it the Divine idea of the Universe.
...
Martin Luther \marginpar{\scriptsize Martin Luther: (1483-1540) was a German professor of theology, composer, priest and a seminal figure in the protestant reformation.} says admirably in his commentary on the Book of Daniel: \marginpar{\scriptsize Book of Daniel: is a 2nd century BC biblical apocalypse.} ``A God is simply that whereon the human heart \emph{rests} with trust, faith, hope and love. If the resting is right, then the God, too, is right; if the resting is wrong, then the God, too, is illusory.''
...
In other words Religion tells us in obeying the law of our being we must obey the \emph{true} law of our being, not the animal or carnal law of our being called by St.~Paul \marginpar{\scriptsize Paul the Apostle: (c.5-c.64 or 67) commonly known as Saint Paul and also known as his Jewish name Saul of Tarsus.} the \emph{law of the mind of the flesh}, and very well defined by the famous disciple of Auguste Comte, \marginpar{\scriptsize Isidore Marie Auguste Fran\c{c}ois Xavier Comte: (1798-1857) was a French philosopher and writer who founded the discipline of praxeology.} Monsieur~Littre, \marginpar{\scriptsize Monsieur: 法语, Mr.\\ Littre [sic: Littr\'e]\\ \'Emile Maximilien Paul Littr\'e: (1801-1881) was a French lexicographer, freemason and philosopher.} as the law of self-preservation\footnote{self preservation in the original book} and reproduction; but the \emph{true} law of our being called by St.~Paul the \emph{law of the mind of the Spirit}, and defined by Confucius as the law of the gentleman.
...
Therefore, Christ said: ``Except your righteousness (or morality) exceed\footnote{exceeds in the original book} the righteousness (or morality) of the Scribes and Pharisees \marginpar{\scriptsize Scribes and Pharisees: is a group of people in the 1st century who have knowledge of the law and could draft legal document.} (\ie, philosopher and moralist) ye\marginpar{\scriptsize ye 古英语 you} shall in no wise enter into the Kingdom of Heaven.''
...
But, like Religion, the law of the gentleman of Confucius tells us we must obey the \emph{true} law of our being, not the law of being of the average man in the street or of the vulgar and impure person, but the law of being of what Emerson \marginpar{\scriptsize Ralph Waldo Emerson: (1803-1882) an American essayist, lecturer, poet.} calls ``the simplest and purest minds'' in the world.
...
This beautiful sentence of Joubert \marginpar{\scriptsize Joseph Joubert: (1754-1824) was French moralist and essayist.} will explain it.
...
You can now understand Goethe's confession of faith which he puts into the mouth of Faust, \marginpar{\scriptsize Faust: is the protagonist of a classic German legend, based on the historical John Georg Faust (c. 1480-1540).} beginning with the words:
\begin{quote}\footnotesize
...
It is this great mistake of the Christian Churches in modern\footnote{modem in the original book} times which has made honest men like the late Mr.~J.~A.~Froude \marginpar{\scriptsize James Anthony Froude: (1818-1894) was an English historian, novelist, biographer and editor.} feel disgusted with the modern\footnote{modem in the original book} Christian Churches.
...
Confucius says: ``In education the feeling and emotion is aroused by the study of \emph{poetry}; the judgment \marginpar{\scriptsize judgment [sic: judgement]} is formed by the study of good taste and good manners; the education of the character is completed by the study of music.''
...
Matthew Arnold, speaking of Homer \marginpar{\scriptsize Homer: 荷马 in Chinese. The author of the Iliad and Odyssey.} and the quality of \emph{nobleness} in his poetry, says: ``The nobleness in the poetry of Homer and of the few great men in literature can refine the raw, natural man, can \emph{transmute} him.''
...
But the author of the book on Filial Piety, (孝经) written in the Han dynasty, the counterpart of the \emph{Imitatio Christi} \marginpar{\scriptsize Imitatio Christi: The imitation of Christ written by Thomas \`a Kempis. It is a Christian devotional book; it is first composed in Latin ca. 1418-1427.} in China, says: ``Let everyone who loves his father and mother depart from iniquity.''
...
\emph{Cogitavi dies antiquos, et annos eternos in menti habui}. \marginpar{\scriptsize eternos [sic: aeternos] \\ menti [sic: mente] \\ Cogitavi dies antiquos, et annos aeternos in mente habui: I have considered the days of old, the years of ancient times.}
...
I want to warn you that when you think of this Spirit of the Chinese People, which I have tried to explain to you, you should bear in mind that it is not a science, philosophy, theosophy, or any ``ism,'' like the theosophy or ``ism'' of Madame Blavatsky \marginpar{\scriptsize Helena Petrovna Blavatsky: (1831-1891) was a Russian occutist, philosopher and author who co-founded the Theosophical Society in 1875.} or Mrs.~Besant. \marginpar{\scriptsize Annie Besant: (1847-1933) was a British socialist theosophist, women's rights activist and writer.}
...
Now last of all I want to ask your permission to recite to you a few lines of poetry from the most Chinese of the English poets, Wordsworth, \marginpar{\scriptsize William Wordsworth: (1770-1850) was a major English Romantic poet.} which better than anything I have said or can say, will describe to you the serene and blessed mood which is the Spirit of the Chinese People.
...
Wordsworth in his lines on Tintern Abbey \marginpar{\scriptsize Tintern Abbey: is a abbey founded by Walter de Clare on 9 May 1131.} says: ---
\begin{quote}\footnotesize
